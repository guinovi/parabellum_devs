...
- [ ] Implementar arquitectura modular y organizada basada en el patrón MVC.
- [ ] Separar claramente responsabilidades: rutas, controladores, modelos y vistas.
- [ ] Utilizar programación asincrónica (`async`/`await`).
- [ ] Implementar middlewares, manejo de rutas, controladores y manejo centralizado de errores.
- [ ] Implementar validaciones simples de entrada/datos.
- [ ] Completar los flujos CRUD con la lógica funcional adecuada.
- [ ] Implementar el control de roles de usuario (crítico).
- [ ] Garantizar consistencia en el manejo de rutas y la conexión entre módulos.

## 2. Base de Datos
- [ ] Integrar base de datos MongoDB utilizando el ODM Mongoose.
...
- [ ] Crear archivo `README.md` con instrucciones técnicas.
